              ...
              <Grid.Row columns={3}>
                <Grid.Column >
                  <Statistic inverted color='yellow' size='mini'>
                    <Statistic.Value >Chicken</Statistic.Value>
                    <Statistic.Label style={{fontSize:'12px'}}>Full cut Chicken</Statistic.Label>
                  </Statistic>
                </Grid.Column>
                <Grid.Column >
                ...
                <Grid.Column >
                  <Statistic size='mini'  color='yellow' inverted>
                    ...
                    <Statistic.Label style={{fontSize:'12px'}}>15 days from the pkg date</Statistic.Label>
                  </Statistic>
                </Grid.Column>
              </Grid.Row>
            </Grid>
