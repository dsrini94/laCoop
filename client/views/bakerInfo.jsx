    ...
    return (<div >
      <Grid>
        <Grid.Row>
          ...
          <br/>
          <center>
            <Segment inverted style={{backgroundColor:'#960728'}}><Header>Chicken Information</Header></Segment>
          </center>
          </Grid.Column>
          <Grid.Column width={2}/>
        </Grid.Row>
        <Grid.Row style={{marginTop:'-50px'}}>
          ...
          <br/>
            <center>
            <Header as='h1'><span className="headers" style={{color:'#960728',fontSize:'35px',marginLeft:'80px'}}>Chicken</span></Header>
              <Image src='https://meatpacking.info/wp-content/uploads/2016/11/A-raw-chicken-014.jpg' size='massive' style={{
        ...
        <Modal size='tiny' open={this.state.open} onClose={this.close}>
            ...
            <br/>
              ...
              <span>Product Route :</span><br/>
                <span>7th Jan 2018,Sun  |Slaughter House| 1K31KZXjcoxhXpRyjH9g5NxFSJIPi2zEXb</span><br/>
                </div>
            </Modal.Content>
            <Modal.Actions>
